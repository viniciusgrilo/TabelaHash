...
//     public TabelaHash(int M){
//         if(M > 0)
//             this.enderecos = new ArrayList[M]; 
//             //cria um vetor estático de tamanho M, onde cada endereco[i] é uma lista encadeada 
//         for(int i = 0; i < M; i++)
//             enderecos[i] = new ArrayList<Integer>();
//     }

//     public int hash(int valor) throws ArithmeticException{
//         int endereco = -1;
//         try{
//             endereco = valor % this.enderecos.length;  //  h(k) = K mod M
//             return endereco; 
//         }catch(ArithmeticException e){
//             throw new ArithmeticException();
//         }   
...
//         try{
//             adress = this.hash(valor);  //calcula o endereço da tabela onde a chave será inserida
//             this.enderecos[adress].add(valor);  //insere o valor na lista encadeada referente ao endereço calculado
//         }catch(ArithmeticException e){
//             throw new ArithmeticException();
//         }    
//     }
...
//         try{
//             adress = this.hash(valor); //calcula o endereço do valor na tabela
//             aux = this.enderecos[adress];  ////cria uma lista auxiliar para ser percorrida
//             i = aux.iterator(); 
...
//             pos = this.buscar(valor); //posicao do valor na lista encadeada
//             if(pos != -1){
//                 this.enderecos[adress].remove(pos);
//             }
//         }catch(IndexOutOfBoundsException e){
//             throw new IndexOutOfBoundsException();
//         }catch(ArithmeticException e){
